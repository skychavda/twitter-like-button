...
export default function TweeterLikeButton({ isLiked, onClick, width, height }) {
  return (
    <React.Fragment>
      <input type="checkbox" id="heart-checkbox" onChange={e => onClick(e.target.checked)} checked={isLiked}/>
      <label htmlFor="heart-checkbox">
        <svg id="heart-svg" viewBox="467 392 58 57" xmlns="http://www.w3.org/2000/svg" height={height} width={width}>
          <g id="circle-groups" fill="none" fill-rule="evenodd" transform="translate(467 392)">
            <path d="M29.144 20.773c-.063-.13-4.227-8.67-11.44-2.59C7.63 28.795 28.94 43.256 29.143 43.394c.204-.138 21.513-14.6 11.44-25.213-7.214-6.08-11.377 2.46-11.44 2.59z" id="heart" fill="#AAB8C2" />
            <circle id="parent-circle" fill="#E2264D" opacity="0" cx="29.5" cy="29.5" r="1.5" />
